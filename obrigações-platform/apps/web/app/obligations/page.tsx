      ...
      <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        ...
        <div className="flex flex-wrap gap-3">
          <Link
            ...
            className="rounded-xl border border-zinc-800 bg-zinc-900 px-5 py-3 text-sm font-medium text-zinc-100 hover:bg-zinc-800"
          >
            Trocar planilha
          </Link>
                  ...
                  <tr key={obligation.id} className="border-b border-zinc-800 hover:bg-zinc-800/40">
                    ...
                    <td className="px-4 py-4 text-sm text-zinc-300">
                      <Link
                        ...
                        className="inline-flex rounded-full bg-zinc-800 px-3 py-1 text-xs font-medium text-zinc-200 hover:opacity-90"
                      >
                        {obligation.status}
                      </Link>
                    </td>
